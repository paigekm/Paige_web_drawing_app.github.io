...
// this array contains all of my colours which can then be called in other places in the program
var colArray=[
    ...
    // test multidimensional colArray is working
    //console.log(colArray[0][1]);
